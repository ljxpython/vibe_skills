...
hooks:
  ...
  Stop:
    - hooks:
        - type: command
          command: "bash .opencode/skills/planning-with-files/scripts/check-complete.sh"
---
...
- **Templates** live in `.opencode/skills/planning-with-files/templates/` (this repo)
- **Scripts** live in `.opencode/skills/planning-with-files/scripts/` (this repo)
...
|----------|-----------------|
| `.opencode/skills/planning-with-files/` | Templates, scripts, reference docs |
